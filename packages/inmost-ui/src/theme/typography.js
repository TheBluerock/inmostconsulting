...
const typography = {
  ...
  p: calculateTypographySizes(FONT_SIZE_BASE, RATIO, 1),
  ...
  h1: calculateTypographySizes(FONT_SIZE_BASE, RATIO, 4),
  big: calculateTypographySizes(FONT_SIZE_BASE, RATIO, 5),
};
