...
const HeroTextWrapper = styled.span`
  display: flex;
  flex: 1;
  grid-column: ${(props) => props.gridColumn || '1/6'}; // Customize grid-column if provided, default to '1/3'
  grid-row: ${(props) => props.gridRow || '1'};         // Customize grid-row if provided, default to '1'
