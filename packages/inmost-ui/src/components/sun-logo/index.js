...
const styles = css`
  #eZ1B2N4W8Pt6_tr {
    animation: eZ1B2N4W8Pt6_tr__tr 3000ms linear infinite normal forwards;
  }

  @keyframes eZ1B2N4W8Pt6_tr__tr {
    0% {
      transform: translate(500px, 500px) rotate(0deg);
    }

    100% {
      transform: translate(500px, 500px) rotate(-12deg);
    }
  }

  #eZ1B2N4W8Pt16_tr {
    animation: eZ1B2N4W8Pt16_tr__tr 3000ms linear infinite normal forwards;
  }

  @keyframes eZ1B2N4W8Pt16_tr__tr {
    0% {
      transform: translate(500px, 500.000018px) rotate(0deg);
    }

    100% {
      transform: translate(500px, 500.000018px) rotate(-12deg);
    }
  }
`;
  ...
  return (
    ...
    >
      <defs>
        <path
          id="eZ1B2N4W8Pt2"
          d="M1000,500c0,276.1-223.9,500-500,500s-500-223.9-500-500h1000Z"
        />
        <path
          id="eZ1B2N4W8Pt3"
          d="M0,500C0,223.9,223.9,0,500,0s500,223.9,500,500L0,500Z"
        />
      </defs>
      <g>
        <g clipPath="url(#eZ1B2N4W8Pt12)">
          <g id="eZ1B2N4W8Pt6_tr" transform="translate(500,500) rotate(0)">
            <g
              transform="translate(-500,-500)"
              style={{ fill: theme.colors.primary, filter:"blur(1px)" }}
            >
              <path d="M580.8,595.4c-4.7,4-9.8,7.7-15.1,11L750,933L559.2,610.1c-5.5,2.9-11.1,5.5-17,7.6L654.5,975.5L535.1,620c-5.9,1.7-12,3-18.3,3.9l35.5,373.4-42.9-372.6c-3.1.2-6.2.3-9.3.3s-6.2-.1-9.3-.3L447.9,997.3l35.5-373.4c-6.2-.8-12.3-2.1-18.3-3.9L345.5,975.5L457.8,617.7c-5.9-2.1-11.6-4.7-17-7.6L250,933L434.3,606.3c-5.3-3.3-10.3-7-15.1-11L165.4,871.6C254,951.4,371.3,1000,500,1000s246-48.6,334.6-128.4L580.8,595.4Z" />
