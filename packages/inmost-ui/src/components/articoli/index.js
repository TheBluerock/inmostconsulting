    ...
    <svg x={0} y={0} viewBox="0 0 1112.2 201.8">
      <g style={{ fill: theme.colors.primary, overflow: "hidden" }}>
        ...
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime }}
          variants={variants}
        />
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime * 2 }}
          variants={variants}
        />
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime * 3 }}
          variants={variants}
        />
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime * 4 }}
          variants={variants}
        />
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime * 5 }}
          variants={variants}
        />
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime * 6 }}
          variants={variants}
        />
        <motion.path
          ...
          initial={"hidden"}
          animate={"visible"}
          transition={{ duration: 1, delay: animationTime * 7 }}
          variants={variants}
        />
      </g>
    </svg>
